...
const projects = [
  ...
  },
  {
    ...
    problem: 'Standard user interfaces and interactive software operate without user feedback loops, failing to recognize human fatigue, distress, or emotional responses in real-time.',
    solution: 'Developed a high-accuracy deep learning vision engine using a custom Convolutional Neural Network (CNN) in TensorFlow and Keras. Integrated OpenCV for live video frame capture, face bounding box tracking, and real-time classification across seven distinct human emotions.',
    tech: ['Python', 'TensorFlow', 'Keras', 'OpenCV', 'Pandas', 'Jupyter Notebook'],
    github: 'https://github.com/Arghya876/Face-Emotion-Recognition.git',
    demo: '#',
  ...
  },
  {
    ...
    problem: 'Standard security systems capture footage of faces being masked or cameras covered, but fail to trigger proactive alerts when an obstruction occurs, leading to security delays.',
    solution: 'Designed a real-time computer vision application using Python and OpenCV Haar cascade classifiers to monitor face visibility. Developed a multi-threaded monitor that detects if a face is obstructed for over 5 seconds and instantly triggers an automated WhatsApp alert message to a predefined number via PyWhatKit.',
    tech: ['Python', 'OpenCV', 'PyWhatKit', 'NumPy', 'Threading'],
    github: 'https://github.com/Arghya876/Face-Obstruction-Detection-with-WhatsApp-Alert.git',
    demo: '#',
